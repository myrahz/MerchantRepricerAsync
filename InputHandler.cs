...
namespace MerchantRepricerAsync
{
    public class InputHandler
    {
        ...
        private readonly MerchantRepricerAsyncSettings _settings;

        public InputHandler(Vector2 windowPosition, MerchantRepricerAsyncSettings settings)
        {
